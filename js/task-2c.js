...
form.onsubmit = function(evt) {
    ...
    for (let i = 0; i < parseInt(varCount.value); ++i) {
        ...
        let text = TEXT.format(commands.first, commands.second, commands.third.slice(0, commands.third.length - 1) + 'x', cmdForms.first, cmdForms.second, cmdForms.third, params.start, finish);
